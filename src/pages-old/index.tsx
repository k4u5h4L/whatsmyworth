            ...
            <div className="w-full bg-white p-10">
                ...
                <div className="mt-12 md:flex items-center">
                    <div className="flex flex-col">
                        ...
                        <input type="date" tabIndex={0} aria-label="Enter date of birth" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" defaultValue="28.03.1997" />
                    </div>
                    <div className="flex flex-col md:ml-12 md:mt-0 mt-8">
